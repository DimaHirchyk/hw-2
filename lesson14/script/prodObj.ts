export interface ProductInfo {
  id: number;
  old_price: number;
  old_usd_price: string; // значення у лапках ⇒ рядок
  price: number;
  min_month_price: number;
  sell_status: string; // можна зробити суворіший літеральний тип, якщо список відомий
  status: string;
  usd_price: string; // теж рядок
  ...
  has_shops: boolean;
  info: null;
  show_in_site: PromoProduct | null;
}
...
export const dataList: ProductInfo[] = [
  {
    id: 344277463,
    old_price: 1395,
    old_usd_price: "37.70",
