class Baner {
  webLinkAndImg: ImageLink[];
  constructor(webLinkAndImg: ImageLink[]) {
...
interface ImageLink {
  title: string; // назва або опис зображення
  imgSrc: string; // шлях або URL до зображення
  link: string; // посилання на сайтwd
  baner: string;
}
...
const imageLinks: ImageLink[] = [
  {
    title: "OpenAI",
    imgSrc:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBdcgkdcDy5z4PYGx_kDJB1AvvC_x1pCBbbQ&s",
    link: "https://openai.com/",
    baner:
      "https://rpk-rostov.ru/wp-content/uploads/2021/10/fl1455871649-2048x1574-min-1024x787.jpg",
  },
  {
    title: "Wikipedia",
    imgSrc:
    ...
    baner:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTXrRG0aHREQDzpdm9cIL8kFBt4JI1_P0DY5w&s",
  },
  {
    title: "GitHub",
    imgSrc:
    ...
    baner:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ73wk5aOd6idlhBoVBTAVWI0sVFf6N77T1vg&s",
  },
  {
    title: "Rozetka",
    ...
    baner:
      "https://ra-sens.com.ua/wp-content/uploads/2022/05/barrier-advertising-banner-mockup_439185-2593-1.jpg",
  },
];
